        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center space-x-4">
            <div className="flex items-center space-x-4">
              <Link
                href="#"
                className="text-olive-green hover:text-light-brown px-3 py-2 rounded-md text-sm font-medium"
              >
                Home
              </Link>
              <Link
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <Link
              href="#"
              className="text-olive-green hover:text-light-brown block px-3 py-2 rounded-md text-base font-medium"
            >
              Home
            </Link>
            <Link
